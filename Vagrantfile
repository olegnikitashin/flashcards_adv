...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  #
  config.vm.provision :shell, path: "https://github.com/olegnikitashin/vagrant-rails/raw/master/script/vagrant_bootstrap.sh", privileged: false
  ...
  #
  config.vm.provision :shell, path: "https://github.com/olegnikitashin/vagrant-rails/raw/master/script/app_specifics.sh", privileged: false
  ...
  #   # Don't boot with headless mode
    vb.gui = true
  #
  #   # You can customize the name that appears in the VirtualBox GUI
    vb.name = "vb_ubuntu"
  #
